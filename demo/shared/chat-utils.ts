...
export const DEFAULT_MOCK_RESPONSES: Record<string, MockResponse> = {
  ...
  hello: {
    content: "Hello! I can help you create mind maps. Try saying 'create a mind map about...'",
  },
  default: {
    content: "I understand. Would you like to create a mind map to visualize your ideas?",
  },
};
...
export const findMockResponse = (
  ...
  if (lowerMessage.includes("mindmap") || lowerMessage.includes("mind map") || lowerMessage.includes("visualize")) {
    return mockResponses.mindmap || DEFAULT_MOCK_RESPONSES.mindmap;
  }
  if (lowerMessage.includes("brainstorm") || lowerMessage.includes("ideas") || lowerMessage.includes("create")) {
    return mockResponses.brainstorm || DEFAULT_MOCK_RESPONSES.brainstorm;
  }
