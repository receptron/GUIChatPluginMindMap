      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-lg shadow-md flex flex-col h-[600px]">
          <div class="p-3 border-b border-gray-200">
            ...
            <p class="text-xs text-gray-500">
              {{ useMockMode ? "Mock mode - try 'mind map' or 'brainstorm'" : "Real API mode" }}
            </p>
          </div>
          ...
          <div class="p-3 border-t border-gray-200">
            <div class="flex gap-2">
              <input
                ...
                type="text"
                placeholder="Type a message... (try 'create a mind map about AI')"
                :disabled="isLoading"
        ...
        <div class="space-y-4">
          ...
          <div v-else class="bg-white rounded-lg shadow-md p-8 text-center text-gray-500">
            ...
            <p class="text-sm mt-2">Try: "create a mind map about AI" or "brainstorm project ideas"</p>
          </div>
